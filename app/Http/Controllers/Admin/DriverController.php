...
class DriverController extends Controller
{
    ...
    public function listData()
    {
        ...
        $datatables = DataTables::of($data)
            ...
            ->addColumn('action', function($row) {
                ...
                //         </a>';
                $btn = '<a href="'.route('admin.driver.delete', $row->id).'" class="btn btn-danger btn-sm">
    ...
    public function destroy($id)
    {
        ...
        File::delete($driver->foto);

        return redirect()->route('admin.driver')->with('success', 'Delete driver successful.');
    }
}

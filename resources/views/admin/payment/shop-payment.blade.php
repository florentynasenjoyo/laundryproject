        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <div class="d-md-flex">
                <ol class="breadcrumb ms-auto">
                    <li><a href="#" class="fw-normal">Order Shop Payment</a></li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 col-lg-6 col-sm-12 col-xs-12">
            <div class="white-box">
                {!! Form::model($order, ['method' => 'post', 'route' => ['admin.payment.shop.postconfirmation', $order->id], 'enctype' => 'multipart/form-data']) !!}
                @csrf
                <div class="form-group">
                    <label for="">Shop</label>
                    <input type="text" name="name" class="form-control" value="{{ $order->shop_name }}" readonly>
